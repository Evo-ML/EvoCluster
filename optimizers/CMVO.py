...
def MVO(objf,lb,ub,dim,N,Max_time, k, points, metric):
    ...
    Sorted_labels=numpy.copy(labelsPred)
    ...
    labelsPredBest=numpy.zeros(len(points))
    ...
    while (Time<Max_time+1):
        ...
        for i in range(0,N):
            ...
            if Inflation_rates[i]<Best_universe_Inflation_rate :
                ...
                labelsPredBest=numpy.array(labelsPred[i,:])
        ...
        for i in range(1,N):
            ...
            for j in range(0,dim):
                ...
                if r1<normalized_sorted_Inflation_rates[i]:
                    ...
                    labelsPred[Back_hole_index,j]=Sorted_labels[White_hole_index,j]
